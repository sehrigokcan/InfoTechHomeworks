...
public class Question05 {
	...
	public static void main(String[] args) {
		...
		boolean sart1 = sifre.startsWith(sifre.toUpperCase().substring(0, 1)); // Character.isUpperCase(charAt(0))
		boolean sart2 = sifre.endsWith(sifre.toLowerCase().substring(sifre.length() - 1)); //// Character.isLowerCase(charAt(sifre.length()-1))
		...
		if (sart1 && sart2 && sart3 && sart4) {
			...
			System.out.print("Islem basarisiz,Lutfen yeni bir sifre girin ");
